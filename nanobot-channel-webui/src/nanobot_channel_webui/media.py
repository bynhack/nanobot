...
class MediaService:
    """Mint signed media URLs for local files."""
    ...
    def __init__(
        ...
        *,
        ...
        secret_text = signing_secret.strip() or auth_token.strip()
        seed = secret_text.encode("utf-8") if secret_text else secrets.token_bytes(32)
